		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">PARADISE <span>RESORT</span><p class="logo_w3l_agile_caption">Luxury at its Finest</p></a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>PARADISE <span> RESORT</span></h4>
	...
	<div class="banner-bottom">
		<div class="container">	
			<div class="agileits_banner_bottom">
				<h3><span>Experience a luxurious stay, enjoy fantastic offers</span> Find our friendly welcoming reception</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">PARADISE RESORT</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">BEACH VIEW</h4>
							<span class="cbp-ig-category">PARADISE RESORT</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">LARGE RESTAURANT</h4>
							<span class="cbp-ig-category">PARADISE RESORT</span>
						</div>
					</li>
					<li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our PARADISE RESORT</h3> 
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/shreya.jpg" style="width:200px" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/shruti.jpg" style="width:200px" alt=" " class="img-responsive" />
					</li>
					</ul>
...
<!-- //gallery -->
  ...
  <!-- visitors -->
	<div class="w3l-visitors-agile" >
		<div class="container">
                 <h3 class="title-w3-agileits title-black-wthree">REVIEWS</h3> 
		</div>
  ...
  <!-- visitors -->
			<div class="copy">
		        <p>© 2021 PARADISE RESORT . All Rights Reserved | Design by <a href="index.php">Shreya Shetty, Shruti Shetty</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
